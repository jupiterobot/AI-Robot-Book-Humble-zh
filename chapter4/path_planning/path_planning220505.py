...
class DrawMap():
    ...
    def paint_tile(self,path):        
        ...
        #self.cmap.set_under('red')   # 值小于0的格子显示为红色
        #self.cmap.set_over('gray')   # 值大于vmax的格子显示为灰色
        #self.cmap.set_bad('yellow')  # 无效值的格子显示为黄色  
    ...
    def paint_tile_heatmap(self,path):
        ...
        self.cmap = plt.cm.Blues
        self.cmap.set_under('red')   # 值小于0的格子显示为红色
        self.cmap.set_over('brown')   # 值大于vmax的格子显示为棕色
        self.cmap.set_bad('yellow')  # 无效值的格子显示为黄色
    ...
    def draw_grid(self,path):
        ...
        cmap = plt.cm.Blues
        cmap.set_under('yellow')  # 值小于0的格子显示为黄色
        cmap.set_over('red')      # 值大于vmax的格子显示为红色
        cmap.set_bad('pink')      # 无效值的格子显示为粉色
...
def main():  
    ...
    if len(sys.argv) != 2:
        print('使用方法: python3 search.py 1 或 2 或 3')
